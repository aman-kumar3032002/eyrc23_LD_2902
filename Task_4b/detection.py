...
# image = cv2.imread('image_1.png', 1)                                    #Reading the image named 'led.jpg' and storing in variable image
image = cv2.imread("image_1.png", 1)                                    #Reading the image named 'led.jpg' and storing in variable image
...
cv2.imwrite(f"{args.image}_detection_results.png", image)                     #Saving the image with detected LEDs
...
with open(f"{args.image}_detection_results.txt", "w") as file:                #Opening a TextFile for writing
